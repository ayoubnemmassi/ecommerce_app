        ...
        children:[ Container( decoration: BoxDecoration(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [Text('Edit Product',style:TextStyle( fontWeight:FontWeight.bold,fontSize: 20, color:Colors.white),),
                SizedBox(height: height*.01,),
                CustomTextField(initialvalue: product.pName, onClick: (value){name=value;}, icon: null, hint: 'Product Name'),
                SizedBox(height: height*.01,),
                CustomTextField(initialvalue: product.pPrice,onClick: (value){price=value;}, icon: null, hint: 'Product Price'),
                SizedBox(height: height*.01,),
                CustomTextField(initialvalue: product.pDescription,onClick: (value){description=value;}, icon: null, hint: 'Product Description'),
                SizedBox(height: height*.01,),
